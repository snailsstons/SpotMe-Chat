...
// POST /api/profile — Profil veröffentlichen / aktualisieren
...
/* ═══ SERVER + PEERJS ═══ */
const server = app.listen(PORT, () => console.log(`[SpotMe] Port ${PORT}`));

const peerServer = ExpressPeerServer(server, {
  path: '/', proxied: true, alive_timeout: 30000, key: 'spotme'
});
